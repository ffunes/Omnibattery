...
const I18N = {
  en: {
    ...
    secExcluded: "Excluded devices", itemExcludedDevice: "Excluded device", itemSolarSurplus: "Solar surplus", itemStrictSolarPriority: "Strict solar priority", itemCoverHome: "Cover home", itemExclusionPct: "Exclusion %",
  ...
  es: {
    ...
    secExcluded: "Dispositivos excluidos", itemExcludedDevice: "Dispositivo excluido", itemSolarSurplus: "Excedente solar", itemStrictSolarPriority: "Prioridad solar estricta", itemCoverHome: "Cubrir hogar", itemExclusionPct: "% excluido",
  ...
  ca: {
    ...
    secExcluded: "Dispositius exclosos", itemExcludedDevice: "Dispositiu exclòs", itemSolarSurplus: "Excedent solar", itemStrictSolarPriority: "Prioritat solar estricta", itemCoverHome: "Cobre la llar", itemExclusionPct: "% exclòs",
  ...
  de: {
    ...
    secExcluded: "Ausgeschlossene Geräte", itemExcludedDevice: "Ausgeschlossenes Gerät", itemSolarSurplus: "Solarüberschuss", itemStrictSolarPriority: "Strikte Solarpriorität", itemCoverHome: "Haus decken", itemExclusionPct: "Ausschluss %",
  ...
  fr: {
    ...
    secExcluded: "Appareils exclus", itemExcludedDevice: "Appareil exclu", itemSolarSurplus: "Surplus solaire", itemStrictSolarPriority: "Priorité solaire stricte", itemCoverHome: "Couvrir maison", itemExclusionPct: "% exclu",
  ...
  nl: {
    ...
    secExcluded: "Uitgesloten apparaten", itemExcludedDevice: "Uitgesloten apparaat", itemSolarSurplus: "Zonne-overschot", itemStrictSolarPriority: "Strikte zonneprioriteit", itemCoverHome: "Huis dekken", itemExclusionPct: "Uitsluiting %",
...
const SYS_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "excluded_device_strict_solar_priority", domain: "switch", lk: "itemStrictSolarPriority", icon: "mdi:ev-station", useName: true },
...
const SYS_HELP = {
  en: {
    ...
    excluded_device_strict_solar_priority: "Requires Solar Surplus. When this device draws power, battery charging yields briefly so an external surplus controller (such as a wallbox with its own grid meter) can ramp up first. Short pauses are held for 5 minutes; genuine leftover export may still charge the battery.",
  ...
  es: {
    ...
    excluded_device_strict_solar_priority: "Requiere Excedente Solar. Cuando el dispositivo consume, la carga de batería cede brevemente para que un regulador externo de excedente (como una wallbox con su propio contador) aumente primero. Las pausas breves se mantienen 5 minutos; el excedente sobrante real aún puede cargar la batería.",
  ...
  ca: {
    ...
    excluded_device_strict_solar_priority: "Requereix Excedent Solar. Quan el dispositiu consumeix, la càrrega de la bateria cedeix breument perquè un regulador extern d'excedent augmenti primer. Les pauses breus es mantenen 5 minuts; l'excedent sobrant real encara pot carregar la bateria.",
  ...
  de: {
    ...
    excluded_device_strict_solar_priority: "Benötigt Solarüberschuss. Wenn das Gerät Leistung bezieht, gibt die Batterieladung kurz Vorrang, damit ein externer Überschussregler zuerst hochregeln kann. Kurze Pausen werden 5 Minuten gehalten; echter Restüberschuss kann weiterhin die Batterie laden.",
  ...
  fr: {
    ...
    excluded_device_strict_solar_priority: "Nécessite Surplus Solaire. Lorsque l'appareil consomme, la charge de la batterie cède brièvement afin qu'un régulateur externe de surplus augmente d'abord sa puissance. Les courtes pauses sont maintenues 5 minutes ; le véritable surplus restant peut encore charger la batterie.",
  ...
  nl: {
    ...
    excluded_device_strict_solar_priority: "Vereist Zonne-overschot. Wanneer het apparaat vermogen afneemt, maakt het laden van de batterij kort plaats zodat een externe overschotregelaar eerst kan opschalen. Korte pauzes worden 5 minuten vastgehouden; echt resterend overschot kan de batterij nog steeds laden.",
