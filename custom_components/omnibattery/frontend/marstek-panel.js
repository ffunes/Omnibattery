...
const I18N = {
  en: {
    ...
    diagDischargeWindow: "Discharge window", diagPredictive: "Predictive charging", diagCurtailment: "Smart pre-discharge", diagSurplusHold: "Surplus price hold", highPriceSurplusExport: "Sell stored solar surplus", diagHighPriceDischarge: "High price discharge", diagDischargeReserve: "Discharge reserve",
  ...
  es: {
    ...
    diagDischargeWindow: "Ventana de descarga", diagPredictive: "Carga predictiva", diagCurtailment: "Predescarga inteligente", diagSurplusHold: "Retención de excedente por precio", highPriceSurplusExport: "Vender excedente solar almacenado", diagHighPriceDischarge: "Descarga por precio alto", diagDischargeReserve: "Reserva de descarga",
  ...
  ca: {
    ...
    diagDischargeWindow: "Finestra de descàrrega", diagPredictive: "Càrrega predictiva", diagCurtailment: "Predescàrrega intel·ligent", diagSurplusHold: "Retenció d'excedent per preu", highPriceSurplusExport: "Vendre excedent solar emmagatzemat", diagHighPriceDischarge: "Descàrrega per preu alt", diagDischargeReserve: "Reserva de descàrrega",
  ...
  de: {
    ...
    diagDischargeWindow: "Entladefenster", diagPredictive: "Prädiktives Laden", diagCurtailment: "Intelligente Vorentladung", diagSurplusHold: "Preisbremse Solarüberschuss", highPriceSurplusExport: "Gespeicherten Solarüberschuss verkaufen", diagHighPriceDischarge: "Entladung bei Hochpreis", diagDischargeReserve: "Entladereserve",
  ...
  fr: {
    ...
    diagDischargeWindow: "Fenêtre de décharge", diagPredictive: "Charge prédictive", diagCurtailment: "Pré-décharge intelligente", diagSurplusHold: "Retenue de surplus selon le prix", highPriceSurplusExport: "Vendre le surplus solaire stocké", diagHighPriceDischarge: "Décharge à prix élevé", diagDischargeReserve: "Réserve de décharge",
  ...
  nl: {
    ...
    diagDischargeWindow: "Ontlaadvenster", diagPredictive: "Voorspellend laden", diagCurtailment: "Slim voorontladen", diagSurplusHold: "Prijsrem zonne-overschot", highPriceSurplusExport: "Opgeslagen zonne-overschot verkopen", diagHighPriceDischarge: "Ontladen bij hoge prijs", diagDischargeReserve: "Ontlaadreserve",
...
const SYS_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "high_price_surplus_export", domain: "switch", lk: "highPriceSurplusExport", icon: "mdi:transmission-tower-export", grp: "highPrice" },
...
const SYS_HELP = {
  en: {
    ...
    high_price_surplus_export: "Sells stored energy that will still be in the battery at sunrise, in the best-paid export slots, when the export price beats what tomorrow's solar refill would forgo. Needs a solar forecast integration that feeds HA's Energy dashboard (Solcast, Forecast.Solar). OFF by default.",
  ...
  es: {
    ...
    high_price_surplus_export: "Vende la energía que seguirá almacenada al amanecer en las franjas de exportación mejor pagadas, si su precio supera el valor de la recarga solar de mañana que se perdería. Necesita una integración de previsión solar que alimente el panel Energía de HA (Solcast, Forecast.Solar). Desactivado por defecto.",
  ...
  ca: {
    ...
    high_price_surplus_export: "Ven l’energia que encara serà a la bateria a la sortida del sol en les franges d’exportació més ben pagades, si el preu supera el valor de la recàrrega solar de demà que es perdria. Cal una integració de previsió solar que alimenti el tauler Energia de HA (Solcast, Forecast.Solar). Desactivat per defecte.",
  ...
  de: {
    ...
    high_price_surplus_export: "Verkauft Energie, die bei Sonnenaufgang noch im Akku wäre, in den bestbezahlten Einspeisezeiten, wenn der Einspeisepreis den entgangenen Wert der morgigen Solarladung übersteigt. Benötigt eine Solarprognose-Integration für das HA-Energie-Dashboard (Solcast, Forecast.Solar). Standardmäßig AUS.",
  ...
  fr: {
    ...
    high_price_surplus_export: "Vend l’énergie qui resterait dans la batterie au lever du soleil pendant les créneaux d’injection les mieux rémunérés, si le prix dépasse la valeur de la recharge solaire de demain ainsi perdue. Nécessite une intégration de prévisions solaires alimentant le tableau de bord Énergie de HA (Solcast, Forecast.Solar). Désactivé par défaut.",
  ...
  nl: {
    ...
    high_price_surplus_export: "Verkoopt energie die bij zonsopgang nog in de batterij zou zitten tijdens de best betaalde terugleveruren, als de terugleverprijs hoger is dan de waarde van de gemiste zonnelading van morgen. Vereist een zonneprognose-integratie voor het HA Energie-dashboard (Solcast, Forecast.Solar). Standaard UIT.",
