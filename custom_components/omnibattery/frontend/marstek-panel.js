...
const SYS_HELP = {
  en: {
    ...
    predictive_min_soc_floor: "Forces an overnight grid charge to reach at least this SOC by the end of the charging window, even when the whole-day solar forecast shows no deficit. Covers the morning gap before solar ramps up. Use the Guaranteed Minimum SOC switch to turn it off.",
  ...
  es: {
    ...
    predictive_min_soc_floor: "Fuerza una carga de red nocturna para alcanzar al menos este SOC al final de la ventana de carga, aunque la previsión solar del día no muestre déficit. Cubre el hueco matinal antes de que arranque el solar. Usa el interruptor SOC Mínimo Garantizado para desactivarlo.",
  ...
  ca: {
    ...
    predictive_min_soc_floor: "Força una càrrega de xarxa nocturna per arribar com a mínim a aquest SOC al final de la finestra de càrrega, encara que la previsió solar del dia no mostri dèficit. Cobreix el buit del matí abans que arrenqui el solar. Fes servir l'interruptor SOC Mínim Garantit per desactivar-lo.",
  ...
  de: {
    ...
    predictive_min_soc_floor: "Erzwingt eine nächtliche Netzladung, um bis zum Ende des Ladefensters mindestens diesen SOC zu erreichen, auch wenn die Tagesprognose kein Defizit zeigt. Deckt die Morgenlücke ab, bevor die Solarerzeugung anläuft. Zum Deaktivieren den Schalter Garantierter Mindest-SOC ausschalten.",
  ...
  fr: {
    ...
    predictive_min_soc_floor: "Force une charge réseau nocturne pour atteindre au moins ce SOC à la fin de la fenêtre de charge, même si la prévision solaire de la journée n'indique aucun déficit. Couvre le creux matinal avant la montée du solaire. Utilise l'interrupteur SOC Minimum Garanti pour le désactiver.",
  ...
  nl: {
    ...
    predictive_min_soc_floor: "Forceert een nachtelijke netlading om aan het einde van het laadvenster minstens deze SOC te bereiken, ook als de zonneprognose voor de dag geen tekort toont. Dekt het ochtendgat voordat de zon op gang komt. Gebruik de schakelaar Gegarandeerd Minimum SOC om het uit te schakelen.",
