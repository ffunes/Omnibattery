...
const I18N = {
  ...
  es: {
    ...
    itemArbitrageMargin: "Margen mínimo de arbitraje", itemRoundTripEfficiency: "Eficiencia de ciclo completo", itemMaxPrice: "Precio máximo (carga)", itemDischargePrice: "Precio mínimo de descarga", itemPriceDischarge: "Descargar solo si precio alto", itemReevaluatePrices: "Reevaluar ahora", itemNegativePriceCharging: "Cargar con precios negativos", itemSmartPredischarge: "Predescarga inteligente", itemNegativeThreshold: "Umbral de inyección negativa", itemPredischargeReserve: "SOC de reserva de predescarga", itemPredischargeExport: "Límite de exportación de predescarga", itemHighPriceExport: "Límite de exportación por precio alto", itemHighPriceCost: "Coste adicional por precio alto",
...
const SYS_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "high_price_discharge_additional_cost", lk: "itemHighPriceCost", icon: "mdi:cash-plus" },
...
const SYS_HELP = {
  en: {
    ...
    high_price_discharge_max_power_w: "Ceiling for that deliberate export, measured net at the grid connection point, so simultaneous solar counts towards it. 0 W leaves the feature inactive: a positive limit is part of a valid configuration.",
    high_price_discharge_additional_cost: "Cost per kWh (wear, taxes, tolls) added to the later buy-back price before a sale counts as profitable. At 0 it sells on the raw price spread.",
