...
2400 AC+, 3000 AC+ and 4000 Mix AC+ models do not expose DC MPPT telemetry 
through this connection.

Existing 2400 AC+ entries are promoted automatically when the device reports
the 3000 Mix AC+ or 4000 Mix AC+ or 4000 Mix Pro product identifier. The saved 
user power ceilings are retained; raise them in the battery options if you want 
to use the larger envelope.
